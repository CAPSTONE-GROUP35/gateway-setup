...
if re.findall(domainRegex, emailFromAddress)[0] == "internal.test":
    ...
    keywordBlacklist = ["casino", "lottery", "viagra", "$$$",
                        ...
                        "on offer", "act fast", "hottie", 
                        "visit this page", "sleep with", "picture trade", 
                        "pic trade", "added you", "dating", "sexy", "sex",
                        "sugar", "strip", "discreet", "dared",
                        "hotter", "hot", "nude", "naked",
                        "free access", "checked your profile",
                        "18 or older", "fool around", "booty call",
                        "butt", "love", "chat room", "chat request",
                        "tinder", "horny", "reconnect", "re-connect",
                        "sent you a photo", "click away", "bed",
                        "liked your profile", "one night stand", 
                        "college girl", "college woman", "married woman", 
                        "single woman", "single mom", "laid", "party invite", 
                        "unusual request", "unread message", "cutie", 
                        "cute girls", "membership offer", "VIP access", 
                        "real man", "her video", "revenge", "orgie", 
                        "open relationship", "private photo", "private video", 
                        "waiting for your response", "viewed your profile",
                        "you've scored", "a player", "tits", "in your area",
                        "friend request", "ultimate challenge", "rate her",
                        "rate him", "NSFW", "dick", "video-selfie",
                        "new matches", "lonesome", "DTF", "anonymous wife",
                        "girl you know", "cheat on", "text her", "crazy dare",
                        "MILF", "posted a pic", "encounter",
                        "wants your attention", "looking to get", 
                        "full access pass", "tagged you", "matches nearby",
                        "prince charming", "local singles", "social experiment",
                        "live chat", "found near you", "pretty lady", 
                        "misses you", "valued member", "video access",
                        "wants to know if", "wants you to", "free membership",
                        "sent u", "please visit this", "to not receive this",
                        "in your city", "eager to meet", "meet women", 
                        "meet men"]
